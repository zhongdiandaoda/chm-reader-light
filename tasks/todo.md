- [x] Add `tsconfig.json`, TypeScript dependencies, and build/typecheck scripts.
...
- [x] Switch scripts and packaging to generated output.
...
- [x] Remove obsolete JavaScript application sources and complete audit.
